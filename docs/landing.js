const content = {
  "pt-BR": {
    ...
    brandName: "FreireAI Companheiro de Alfabetização",
    ...
    highlightLanguagesValue: "3 idiomas",
    highlightLanguagesLabel: "PT-BR, EN e ES",
    highlightFlowValue: "Ciclo em 5 passos",
    highlightFlowLabel: "Escutar, codificar, perguntar, planejar e circular",
    highlightPostureValue: "Conduzido pelo educador",
    highlightPostureLabel: "Os rascunhos da IA ficam sob revisão humana",
    methodEyebrow: "Método e projeto",
    methodTitle: "Construído para uma prática de alfabetização dialógica",
    methodIntro: "FreireAI usa Gemma como mediador, não como oráculo. Ele transforma a linguagem dos estudantes em temas, perguntas e codificações que educadores podem revisar e adaptar.",
    featureListenTitle: "Escutar antes de propor",
    featureListenBody: "Mapeia palavras geradoras, evidências e tensões a partir da fala ou escrita dos estudantes.",
    featureCodifyTitle: "Criar codificações situadas",
    ...
    feedbackTitle: "Ajude-nos a melhorar o piloto",
  ...
  en: {
    ...
    navVideos: "Videos",
    navFeedback: "Feedback",
    brandName: "FreireAI Literacy Companion",
    languageLabel: "Language",
    heroEyebrow: "Gemma 4 Good pilot",
    heroTitle: "FreireAI Literacy Companion",
    heroLede: "A trilingual AI companion that helps educators listen first, create situated literacy prompts, and facilitate digital culture circles.",
    openDemo: "Open demo",
    watchVideos: "Watch videos",
    highlightLanguagesValue: "3 languages",
    highlightLanguagesLabel: "PT-BR, EN, and ES",
    highlightFlowValue: "5-step cycle",
    highlightFlowLabel: "Listen, codify, question, plan, circle",
    highlightPostureValue: "Educator-led",
    highlightPostureLabel: "AI drafts remain under human review",
    methodEyebrow: "Method and project",
    methodTitle: "Built for dialogical literacy practice",
    methodIntro: "FreireAI uses Gemma as a mediator, not as an oracle. It turns learner language into themes, questions, and codifications that educators can review and adapt.",
    featureListenTitle: "Listen before proposing",
    featureListenBody: "Map generative words, evidence, and tensions from learner speech or writing.",
    featureCodifyTitle: "Create situated codifications",
    ...
    feedbackTitle: "Help us improve the pilot",
  ...
  es: {
    ...
    brandName: "FreireAI Compañero de Alfabetización",
    languageLabel: "Idioma",
    heroEyebrow: "Piloto Gemma 4 Good",
    ...
    highlightLanguagesValue: "3 idiomas",
    highlightLanguagesLabel: "PT-BR, EN y ES",
    highlightFlowValue: "Ciclo de 5 pasos",
    highlightFlowLabel: "Escuchar, codificar, preguntar, planificar y dialogar",
    highlightPostureValue: "Conducido por el educador",
    highlightPostureLabel: "Los borradores de IA quedan bajo revisión humana",
    methodEyebrow: "Método y proyecto",
    methodTitle: "Construido para una práctica de alfabetización dialógica",
    methodIntro: "FreireAI usa Gemma como mediador, no como oráculo. Convierte el lenguaje de estudiantes en temas, preguntas y codificaciones que educadores pueden revisar y adaptar.",
    featureListenTitle: "Escuchar antes de proponer",
    featureListenBody: "Mapea palabras generadoras, evidencias y tensiones a partir del habla o escritura de estudiantes.",
    featureCodifyTitle: "Crear codificaciones situadas",
    ...
    feedbackTitle: "Ayúdenos a mejorar el piloto",
...
function adjustDemoLinksForLocalFiles() {
  ...
  document.querySelectorAll(".demo-link").forEach((link) => {
    link.setAttribute("href", "https://freireai-literacy-companion-pilot.onrender.com/demo");
  });
}

languageSelect.addEventListener("change", (event) => setLanguage(event.target.value));
adjustDemoLinksForLocalFiles();
